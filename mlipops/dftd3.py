...
class DFTD3(torch.nn.Module):
    ...
    This is a highly accurate model for dispersion that depends only on positions and atomic numbers.  It is described
    in  https://doi.org/10.1063/1.3382344 and https://doi.org/10.1002/jcc.21759.
    ...
    def __init__(self, neighbor_list: NeighborList, s8: float, a1: float, a2: float, prefactor: float, bohr_radius: float):
        ...
        self.pairwise = Pairwise(DFTD3Calculator(s8, a1, a2, bohr_radius), None, None)
